...
client.on('message', message => {
    if (message.content === '3shelp') {
        let helpEmbed = new Discord.RichEmbed()
        .setTitle('**أوامر الميوزك...**')
        .setDescription('**(3s) برفكس البوت**')
        ...
        .setFooter('(3shelp all) لاظهار الاوامر العامة')
      message.channel.send(helpEmbed);
    }
});

client.on('message', message => {
    if (message.content === '3shelp all') {
        let helpEmbed = new Discord.RichEmbed()
        .setTitle('**أوامر عامة...**')
        .addField('avatar', "افاتار الشخص المطلوب")
        .addField('gif', 'البحث عن جيف انت تطلبه')
        .addField('ping', 'معرفة ping البوت')
        .setFooter('Ba @- Riverrr ?#1111')
      message.channel.send(helpEmbed);
    }
});
...
client.user.setGame(`كثرة الحاقدين تثير اعجابي..`,"http://twitch.tv/Death Shop")
